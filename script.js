...
function Calendar(){
    ...
    function CalendarDiv(){
        ...
        let nextLastDate = new Date(date.getFullYear(),date.getMonth()+1,0).getDay();
        let firstDayIndex = new Date(date.getFullYear(),date.getMonth(),0).getDay()+1;
        let nextDays = 6 - nextLastDate;
        const months = ["January","February","March","April","May","June","July","August","September","October","November","December"];
        document.querySelector('.date p').innerHTML = date.getFullYear();// toDateString();
